...
<body class="bg-[#f4f7f6] min-h-screen flex items-center justify-center relative overflow-hidden">
    ...
    <div class="bg-white p-8 sm:p-10 rounded-2xl shadow-sm border border-gray-100 w-full max-w-md relative z-10">
        ...
        <div class="flex flex-col items-center justify-center mb-8">
            ...
            <h1 class="text-2xl font-bold text-gray-900 text-center">Selamat Datang</h1>
            <p class="text-gray-500 text-sm mt-1 text-center">Silakan masuk ke akun Anda untuk melanjutkan.</p>
        </div>
        ...
        <form action="{{ url('/login') }}" method="POST" class="space-y-5">
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-900 mb-2">Email atau NIM</label>
                <div class="relative">
            ...
            <button type="submit" class="w-full bg-[#0b5cff] hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-lg transition-colors text-sm flex justify-center items-center gap-2 mt-2">
